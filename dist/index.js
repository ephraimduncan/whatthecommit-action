...
Object.defineProperty(exports, "__esModule", { value: true });
const debug_1 = __webpack_require__(179);
const utils_1 = __webpack_require__(847);
...
try {
  var supportsColor = __webpack_require__(361);
...
const hasFlag = __webpack_require__(686);
...
module.exports = {
   ...
   FetchSummary: __webpack_require__(800),
...
try {
	...
	const supportsColor = __webpack_require__(361);
...
module.exports = __webpack_require__(285)(exports);
...
const debug_1 = __importDefault(__webpack_require__(485));
...
async function __() {
  ...
  await git.pull(['--rebase', '--allow-unrelated-histories']);
  await git.push();
}
...
const responses = __webpack_require__(366);
